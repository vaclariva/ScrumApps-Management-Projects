...
@section('filter-content-left')
    <div class="nav flex-column align-items-start gap-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-warehouse"
            data-bs-toggle="pill" data-bs-target="#tab-warehouse" type="button" role="tab" aria-controls="tab-warehouse"
            aria-selected="true">
            <span>Lokasi</span>
            <div class="tbr_filter--badge">
                <span>0</span>
        ...
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-product"
            data-bs-toggle="pill" data-bs-target="#tab-product" type="button" role="tab" aria-controls="tab-product"
            aria-selected="true">
            <span>Produk</span>
            <div class="tbr_filter--badge">
                <span>0</span>
        ...
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-correction" data-bs-toggle="pill"
            data-bs-target="#tab-correction" type="button" role="tab" aria-controls="tab-correction" aria-selected="true">
            <span>Koreksi</span>
            <div class="tbr_filter--badge">
                <span>0</span>
            </div>
...
@section('filter-content-right')
    <div class="tab-content" id="tab-visibility-content">
        ...
        <div
            ...
            id="tab-warehouse"
            role="tabpanel"
            aria-labelledby="tab-warehouse-tab" tabindex="0"
        >
            @if (count($warehouses) > 0)
                @include('products.partials.listing.filter-search', ['filterId' => 'filter-warehouse', 'type' => 'search-more'])
                <div class="mt-8 text-center tbr_search--result">
                        ...
                        <div @class(['col tbr_input--parent mb-4 in-load-more', 'd-none'=> $loop->iteration > 10])>
                            <label class="form-check form-check-inline d-flex align-items-center ">
                                <input class="form-check-input" type="checkbox" name="warehouse[]"
                                    value="{{ $warehouse->id }}" data-text="{{ $warehouse->name }}"/>
                    ...
                    <div @class(['text-center tbr_search--more', 'd-none'=> count($warehouses) <= 10])>
        ...
        <div
            ...
            id="tab-product"
            role="tabpanel"
            aria-labelledby="tab-product-tab" tabindex="0"
        >
            @if (count($productVariants) > 0)
                @include('products.partials.listing.filter-search', ['filterId' => 'filter-product', 'type' => 'search-more'])
                <div class="mt-8 text-center tbr_search--result">
                    <span class="text-muted fw-semibold tbr_search--empty d-none">Kata kunci tidak ditemukan</span>
                    <div class="row row-cols-2">
                        ...
                        <div @class(['col tbr_input--parent mb-4 in-load-more', 'd-none'=> $loop->iteration > 10])>
                            <label class="form-check form-check-inline d-flex align-items-center ">
                                <input class="form-check-input" type="checkbox" name="product[]"
                                    value="{{ $productVariant->id }}" data-text="{{ $productVariant->variant_name }}"/>
                                <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                    ...
                    <div @class(['text-center tbr_search--more', 'd-none'=> count($productVariants) <= 10])>
                        <a type="button" class="fw-bold tbr_hover--opacity tbr_text--primary"
                            onclick="loadMoreFilter({el: this})" data-search-page='1'>
                            Lebih banyak
                        </a>
            ...
            @else
                <div class="text-center text-muted">Tidak ada data produk yang tersedia</div>
            @endif
        </div>
            ...
            <div class="mt-8 text-center tbr_search--result">
                ...
                <div class="d-flex justify-content-between gap-5 text-break">
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="type[]" value="Stock In" data-text="Stock In"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Stock In
                        </span>
                    </label>
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="type[]" value="Stock Out" data-text="Stock Out"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Stock Out
                        </span>
                    </label>
        ...
        <div class="tab-pane fade" id="tab-correction" role="tabpanel" aria-labelledby="tab-correction-tab" tabindex="0">
            @include('products.partials.listing.filter-search', ['filterId' => 'filter-correction', 'type' => 'search'])
            <div class="mt-8 text-center tbr_search--result">
                <span class="text-muted fw-semibold tbr_search--empty d-none">Kata kunci tidak ditemukan</span>
                <div class="d-flex justify-content-between gap-5 text-break">
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="correction" value="Dengan Koreksi" data-text="Dengan Koreksi"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Dengan Koreksi
                        </span>
                    </label>
