<div class="modal fade" id="modal_create_project" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            ...
                            <div class="d-flex align-items-center gap-3 icon-picker-group">
                                <div class="dropdown">
                                    <button type="button" class="btn btn-light btn-icon icon-picker-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="selected-icon ki-duotone ki-graph-3 text-gray-500 fs-1">
                                ...
                                <input type="hidden" name="icon" class="icon-picker-input" value="ki-duotone ki-graph-3">
                                <input type="text" class="tbr_form form-control w-100" name="name" placeholder="Masukkan Nama Proyek" />
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-8">
                            ...
                            <div class="d-flex gap-20">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" value="internal" name="label" id="internal"/>
                                    <label class="form-check-label" for="internal">
                                        Internal
                                    </label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" value="external" name="label" id="external"/>
                        ...
                        <div class="form-group mb-8">
                            ...
                            <select name="user_id" class="tbr_form form-control form-select form-select-solid" id="user" data-control="select2">
                                ...
                                @foreach ($users as $user)
                                        <option value="{{ $user->id }}" data-image="{{ $user->photo_path ? asset($user->photo_path) : asset('assets/images/avatar.png') }}" {{ old('user_id') == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}
                                @endforeach
                            </select>
                        </div>
