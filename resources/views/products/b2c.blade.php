    ...
    <div class="card rounded-top-0">
        <div class="card-body">
            ...
            >
                ...
                <div class="row form-group mb-8">
                    <div class="col-lg-4 d-flex align-items-center gap-3 mb-4 mb-lg-0">
                        <label for="price" class="h6 tbr_font--weight-bold m-0">Harga End User</label>
                    </div>
                    <div class="col-lg-8">
                ...
                <div class="row form-group mb-8">
                    <div class="col-lg-4 d-flex align-items-center gap-3 mb-4 mb-lg-0">
                        ...
                        <a type="button" data-bs-toggle="tooltip" data-bs-custom-class="tbr_tooltip--mw-fit" data-bs-title="<span class='fw-semibold'>Toggle ini digunakan untuk menampilkan atau <br/>menyembunyikan produk di aplikasi B2C.</span>" data-bs-html="true" data-bs-placement="bottom">
...
@push('blockfoot')
    ...
    <script src="{{ asset('assets/js/products/b2c.js') }}"></script>
    <script>
        new AutoNumeric(".autonumeric", {{ $product_variants->price ?? 0}}, {
            decimalPlaces: 0,
            decimalCharacter: ',',
            digitGroupSeparator: '.',
            minimumValue: 0
