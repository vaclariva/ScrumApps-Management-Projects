...
@endsection
@push('blockhead')
    <link rel="stylesheet" href="{{ asset('assets/css/products/b2b-variant.css') }}">
@endpush
@section('content')
                    ...
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th class="d-flex align-items-center gap-2 border-0">
                                ...
                                <a type="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tbr_tooltip--mw-fit" data-bs-title="<span class='fw-semibold'>Toggle ini digunakan untuk menampilkan atau <br/>menyembunyikan produk di aplikasi B2B.</span>" data-bs-html="true" data-bs-placement="bottom">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-danger form-check-solid">
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                id="star_price"
                                                data-ajax-disabled="true"
                                                value="{{ $product_variant->star_price ?? '0' }}"
                                            />
                                        </div>
                                    </div>
                                </td>
...
@push('blockfoot')
    <script>
        const urlAllVisible = '{{ route('products.storeB2bVisibility', $product->id) }}';
        const storeUrl = '{{ route('products.storeB2b', $product->id) }}';
    </script>
    <script src="{{ asset('assets/js/autonumeric.js') }}"></script>
    <script src="{{ asset('assets/js/products/b2b-variant.js') }}"></script>
    <script>
