    ...
    <div class="card">
        ...
        >
            <div class="card-header flex-column ">
                <h5>Formulir Tambah Produk</h5>
                <span class="text-gray-600">Isi formulir dibawah untuk menambahkan produk.</span>
            </div>
            <div class="card-body">
                ...
                <div class="row form-group mb-8">
                    ...
                    <div class="col-lg-8">
                        <select name="categories[]" class="form-select tbr_form  form-select-solid" data-control="select2" data-close-on-select="false"  multiple="multiple">
                ...
                <div class="row form-group mb-8">
                    ...
                    <div class="col-lg-8 d-flex gap-20">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" value="Popular" name="type" id="popular"  />
                            <label class="form-check-label" for="popular">
                                Populer
                            </label>
                        </div>
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" value="Pengembangan" name="type" id="pengembangan"  />
                ...
                <div class="row form-group mb-8">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        ...
                        <a type="button" data-bs-toggle="tooltip" data-bs-custom-class="tbr_tooltip--mw-fit" data-bs-title="<span class='fw-semibold'>Pilih <span class='tbr_text--primary'>Ya</span> jika produk ini memiliki variasi seperti<br/>ukuran, warna, atau tipe. Jika <span class='tbr_text--primary'>Tidak</span> produk akan<br/>ditampilkan sebagai satu versi tanpa variasi.</span>" data-bs-html="true" data-bs-placement="bottom">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-8 d-flex gap-20">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" value="0" name="has_variant" id="withoutVarian"  />
                            <label class="form-check-label" for="withoutVarian">
                                Tidak
                            </label>
                        </div>
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" value="1" name="has_variant" id="withVarian"  />
                ...
                <div id="parent-not-variant" style="display: none">
                    <div class="row form-group mb-8">
                        <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="card-footer d-flex justify-content-end gap-4">
                ...
                <button anim="ripple" type="submit" class="btn tbr_btn tbr_btn--primary">Lengkapi Harga</button>
            </div>
        </form>
    </div>
@endsection
@push('blockfoot')
    <script src="{{ asset('assets/js/products/create.js') }}"></script>
@endpush
