...
@section('filter-content-left')
    <div class="nav flex-column align-items-start gap-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <button class="nav-link active d-flex gap-2 flex-center text-nowrap" id="button-tab-warehouse"
            ...
            <div class="mt-8 text-center tbr_search--result">
                ...
                <div class="d-flex justify-content-between gap-5 text-break">
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="status[]" value="Available" data-text="Available"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Available
                        </span>
                    </label>
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="status[]" value="Low" data-text="Low"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Low
                        </span>
                    </label>
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="status[]" value="Out of Stok" data-text="Out of Stok"/>
                        <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                            Out of Stok
                        </span>
                    </label>
