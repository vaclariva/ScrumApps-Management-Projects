...
@endsection
@push('blockhead')
    <link rel="stylesheet" href="{{ asset('assets/css/inventories/stock-in.css') }}">
...
@section('content')
    <div class="card">
        <form action="{{ route('inventories.store') }}" method="POST" class="tbr_main_form">
            <input type="text" name="type" value="Stock In" hidden>
            <div class="card-header flex-column">
                <h5>Formulir Stock In</h5>
                <span class="text-gray-600">Isi formulir dibawah untuk menambahkan stock in.</span>
            </div>
            <div class="card-body">
...
@push('blockfoot')
    ...
    <script src="{{ asset('assets/js/inventories/stock-in.js') }}"></script>
@endpush
