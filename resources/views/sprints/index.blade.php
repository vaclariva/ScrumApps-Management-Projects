    ...
    <div class="card">
        <div class="card-header d-flex text-center">
            <div class="flex-column">
                <h3 class="card-title fw-semibold">Daftar Sprint</h3>
        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-lg-row justify-content-lg-between gap-4 mb-8">
                ...
                <div class="d-flex flex-column flex-lg-row gap-4">
                    @include('include.default-datatable-search', ['fullInResponsive' => true, 'tableId' => 'table-sprints'])
            ...
            @include('include.default-datatable', [
                ...
                'columns' => ['No', 'Nama', 'Deskripsi', 'Tanggal Mulai', 'Tanggal Selesai', 'Hasil Review', 'Hasil Retrospektif', 'Status','Aksi']
            ])
        </div>
    </div>

    @include('sprints.modal-create')
    @include('sprints.modal-edit')
    @include('projects.modal-edit')
    @include('include.default-modal-delete')

    @push('blockfoot')
        <script>
            const urlDatatable = '{{ route('sprints.list', ['project' => $project]) }}';
        ...
        <script src="{{ asset('assets/js/sprints/index.js') }}"></script>
        <script src="{{ asset('assets/js/sprints/create.js') }}"></script>
        <script src="{{ asset('assets/js/sprints/edit.js') }}"></script>
