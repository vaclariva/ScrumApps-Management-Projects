...
@section('filter-content-left')
    <div class="nav flex-column align-items-start gap-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <button class="nav-link active d-flex gap-2 flex-center text-nowrap" id="button-tab-date"
            data-bs-toggle="pill" data-bs-target="#tab-date" type="button" role="tab" aria-controls="tab-date"
            aria-selected="true">
            <span>Tanggal</span>
        ...
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-payment" data-bs-toggle="pill"
            data-bs-target="#tab-payment" type="button" role="tab" aria-controls="tab-payment" aria-selected="true">
            <span>Pembayaran</span>
            <div class="tbr_filter--badge">
                <span>0</span>
            </div>
        </button>
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-delivery" data-bs-toggle="pill"
            data-bs-target="#tab-delivery" type="button" role="tab" aria-controls="tab-delivery" aria-selected="true">
        ...
        <button class="nav-link d-flex gap-2 flex-center text-nowrap" id="button-tab-status" data-bs-toggle="pill"
            data-bs-target="#tab-status" type="button" role="tab" aria-controls="tab-status" aria-selected="true">
            <span>Status</span>
            <div class="tbr_filter--badge">
                <span>0</span>
            </div>
...
@section('filter-content-right')
    <div class="tab-content" id="tab-visibility-content">
        <div
            ...
            id="tab-date"
            role="tabpanel"
            aria-labelledby="tab-date-tab" tabindex="0"
        >
            <div class="input-group flex-root">
                ...
                <input type="text" class="tbr_form form-control tbr_daterangepicker" placeholder="Pilih rentang tanggal" name="date" id="date" value=""/>
            </div>
        </div>
        <div class="tab-pane fade" id="tab-type" role="tabpanel" aria-labelledby="tab-type-tab" tabindex="0">
            @include('orders.partials.filter-search', ['filterId' => 'filter-type', 'type' => 'search'])
            <div class="mt-8 text-center tbr_search--result">
                ...
                <div class="d-flex justify-content-between gap-5 text-break">
                    <label class="form-check form-check-inline d-inline-flex align-items-center tbr_input--parent">
                        <input class="form-check-input" type="checkbox" name="type[]" value="Populer" data-text="Populer"/>
        ...
        <div class="tab-pane fade" id="tab-payment" role="tabpanel" aria-labelledby="tab-payment-tab" tabindex="0">
            @include('orders.partials.filter-search', ['filterId' => 'filter-payment', 'type' => 'search'])
            <div class="mt-8 text-center tbr_search--result">
                <span class="text-muted fw-semibold tbr_search--empty d-none">Kata kunci tidak ditemukan</span>
                <div class="row row-cols-2">
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="payment[]" value="unpaid" data-text="Belum Bayar"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Belum Dibayar
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="payment[]" value="partial" data-text="Dibayar Sebagian"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dibayar Sebagian
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="payment[]" value="paid" data-text="Lunas"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Lunas
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="payment[]" value="canceled" data-text="Dibatalkan"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dibatalkan
                            </span>
                        </label>
        ...
        <div class="tab-pane fade" id="tab-delivery" role="tabpanel" aria-labelledby="tab-delivery-tab" tabindex="0">
            @include('orders.partials.filter-search', ['filterId' => 'filter-delivery', 'type' => 'search'])
            <div class="mt-8 text-center tbr_search--result">
                <span class="text-muted fw-semibold tbr_search--empty d-none">Kata kunci tidak ditemukan</span>
                <div class="row row-cols-3">
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="delivery[]" value="packaged" data-text="Dikemas"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dikemas
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="delivery[]" value="shipped" data-text="Dikirim"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dikirim
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="delivery[]" value="delayed" data-text="Ditunda"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Ditunda
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="delivery[]" value="received" data-text="Terkirim"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Terkirim
                            </span>
                        </label>
                    ...
                    <div class="col tbr_input--parent mb-4">
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="delivery[]" value="canceled" data-text="Dibatalkan"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dibatalkan
                            </span>
                        </label>
        ...
        <div class="tab-pane fade" id="tab-status" role="tabpanel" aria-labelledby="tab-status-tab" tabindex="0">
            @include('orders.partials.filter-search', ['filterId' => 'filter-status', 'type' => 'search'])
            <div class="mt-8 text-center tbr_search--result">
                <span class="text-muted fw-semibold tbr_search--empty d-none">Kata kunci tidak ditemukan</span>
                <div class="row row-cols-3">
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="status[]" value="waiting" data-text="Menunggu"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Menunggu
                            </span>
                        </label>
                    ...
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="status[]" value="processing" data-text="Diproses"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Diproses
                            </span>
                        </label>
                    ...
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="status[]" value="completed" data-text="Selesai"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Selesai
                            </span>
                        </label>
                    ...
                    <div class='col tbr_input--parent mb-4'>
                        <label class="form-check form-check-inline d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" name="status[]" value="canceled" data-text="Dibatalkan"/>
                            <span class="fw-medium ms-3 tbr_text--placeholder-active text-start">
                                Dibatalkan
                            </span>
                        </label>
