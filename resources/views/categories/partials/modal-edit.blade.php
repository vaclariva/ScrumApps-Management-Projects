<div class="modal fade" id="tbr-modal-edit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                ...
                <form action="" class="tbr_main_form" method="POST">
                    ...
                    <div class="card-header d-flex justify-content-between gap-4">
                        <div>
                            ...
                            <span class="text-gray-600">Isi formulir dibawah untuk memperbarui kategori.</span>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-8">
                            <label for="name-edit" class="h6 tbr_font--weight-bold">Nama</label>
                            <input type="text" name="name" id="name-edit" class="tbr_form form-control">
                        </div>
                        <div class="form-group">
                            <label for="desc-edit" class="h6 tbr_font--weight-bold">Keterangan</label>
                            <textarea name="desc" spellcheck="false" class="tbr_form form-control" id="desc-edit" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-end gap-4">
                        <button type="button" data-bs-dismiss="modal" anim="ripple" class="btn tbr_btn tbr_btn--light">Batal</button>
