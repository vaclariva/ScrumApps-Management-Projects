...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex text-center">
            <div class="flex-column">
                <h3 class="card-title fw-semibold">Daftar Member</h3>
                <span class="text-gray-600 text-sm">
                    Halaman ini digunakan untuk menyimpan daftar member pada proyek sebagai tim pengembang.
                </span>
            </div>
        </div>
        <div class="card-body">
            <div class="d-flex flex-column flex-lg-row justify-content-lg-between gap-4 mb-8">
                ...
                <div class="d-flex flex-column flex-lg-row gap-4">
                    @include('include.default-datatable-search', ['fullInResponsive' => true, 'tableId' => 'table-teams'])
                </div>
            </div>
            @include('include.default-datatable', [
                'tableId' => 'table-teams',
                'columns' => ['No', 'Nama', 'Peran', 'Aksi']
            ])
        </div>
    </div>

    @include('teams.modal-create')
    @include('teams.modal-edit')
    ...
    @push('blockfoot')
        ...
        <script src="{{ asset('assets/js/teams/index.js') }}"></script>
        <script src="{{ asset('assets/js/teams/create.js') }}"></script>
        <script src="{{ asset('assets/js/teams/edit.js') }}"></script>
