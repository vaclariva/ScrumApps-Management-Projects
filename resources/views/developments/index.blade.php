...
@section('content')
        ...
        <div class="card-header d-flex text-center">
            ...
            <div class="d-flex gap-2">
                @if ($project->trello_board_id)
                    <a href="https://trello.com/b/{{ $project->trello_board_id }}" target="_blank" class="btn tbr_btn tbr_btn--info d-flex flex-center gap-2">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span>Lihat di Trello</span>
                    </a>
                @else
                    @if (auth()->user()->isSuperAdmin || auth()->user()->isBusinessAnalyst)
                        <button id="btn-integrate-trello" class="btn tbr_btn tbr_btn--success d-flex flex-center gap-2" data-project-id="{{ $project->id }}">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <span id="trello-btn-text">Integrasikan dengan Trello</span>
                        </button>
                    @endif
                @endif
    ...
    @push('blockfoot')
        ...
        <script src="{{ asset('assets/js/developments/trello-integration.js') }}"></script>
