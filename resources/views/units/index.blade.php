@extends('layouts.app')
@section('pageTitle', 'Satuan Produk')
@section('breadcrumb')
...
@section('content')
    <div class="row gap-4 gap-lg-0">
        <div class="col-lg-5">
            <div class="card">
                <form action="{{ route('units.store') }}" method="POST" class="tbr_main_form">
                    <div class="card-header">
                        <div>
                            <h5>Satuan</h5>
                            <span class="text-gray-600">Isi formulir dibawah untuk menambahkan satuan.</span>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-8">
                        @include('include.default-datatable-search', ['tableId' => 'table-unit', 'fullInResponsive' => true])
                    </div>
    ...
    @include('units.partials.modal-edit')
    @push('blockfoot')
        <script>
            const urlDatatable = '{{ route('units.list') }}';
        </script>
        ...
        <script src="{{ asset('assets/js/units/index.js') }}"></script>
    @endpush
@endsection
