...
$(function(){
    ...
    $(document).on("change", 'input[name="checklist_correction[]"]', function () {
        ...
        let textArea = trCorrectionInput.find('textarea');
        if (isChecked) {
    ...
    $(document).on("select2:select", "select[name='product_variant_id[]']", function () {
            ...
            <div class="input-group flex-root md">
                <span class="input-group-text">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12 18V6" stroke="#A1A5B7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </span>
                <input type="number-with-coma" class="tbr_form form-control md autonumeric" name="quantity[]" id="quantity--${indexDynamicForm}" value=""/>
            </div>
        </td>
        <td>
    ...
    <tr style="display: none" class="tbr_correction">
        <td colspan="5" class="pt-0">
            <div class="accordion accordion-icon-toggle tbr_accordion" id="accodion-parent-${indexDynamicForm}">
                <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-${indexDynamicForm}" aria-expanded="false">
